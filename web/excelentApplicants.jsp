...
<head>
    <meta charset="utf-8">
    <title>Excelent applicants</title>
    <link href="css/style.css" rel="stylesheet" type="text/css">
</head>

<body>
<form action="/findExcelentApplicants" method="get">
    <legend>Find excelent applicants</legend>
    <fieldset>
        <label for="mark">Enter mark:</label>
        <input type="number" name="mark" min="100" max="200" step="0.5">
    </fieldset>
    <button type="submit" class="find">Find</button>
</form>
<p style="color: red;">${errorString}</p>
<form>
    <legend>Find applicants who have excelent marks</legend>
    <fieldset>
